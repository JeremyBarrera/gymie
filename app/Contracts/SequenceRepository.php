 ...
 *
 * OSS default uses JSON-backed settings, while the platform/tenancy
 * implementation can override this binding to generate sequences per-tenant
 * safely (e.g. with row locks).
 */
