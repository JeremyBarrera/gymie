        ...
        <form id="scan-form" method="POST" action="{{ route('checkin.submit', ['token' => $token]) }}">
            ...
            <div class="form-group">
                <label class="form-label" for="value">
                    ...
                    <span id="value-label-text">{{ __('app.scan.phone_number') }}</span>
                </label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="goal" id="goal" class="form-input"
                       placeholder="{{ __('app.placeholders.goal') }}"
                       maxlength="100">
            </div>
    ...
    <script>
        ...
        if (identifierType && valueInput) {
            ...
            const syncInputMode = () => {
                ...
                if (valueLabelText) {
                    valueLabelText.textContent = identifierType.options[identifierType.selectedIndex].textContent.trim();
                }
            };
