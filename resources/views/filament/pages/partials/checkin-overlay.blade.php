                        ...
                        <div class="relative shrink-0">
                            @if($checkInMember->photo)
                                <img
                                    ...
                                    onclick='event.stopPropagation(); window.dispatchEvent(new CustomEvent("open-photo-zoom", { detail: { src: @js(asset('storage/'.$checkInMember->photo)), alt: @js($checkInMember->name) } }))'
                                >
                            @else
